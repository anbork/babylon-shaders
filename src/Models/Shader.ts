...
export const shader = (): BABYLON.NodeMaterial => {
  ...
  NormalTrim.texture = new BABYLON.Texture("assets/TEX_Trim_A_N.png", null, false, false, 3);
  ...
  NormalDetail.texture = new BABYLON.Texture("assets/TEX_MP_Detail_Fabric_N_A.jpg", null, false, false, 3);
  ...
  // InputBlock
  var uv1 = new BABYLON.InputBlock("uv2");
  ...
  ModelNormalStrength.value = 2.13;
  ...
  MaskTrim.texture = new BABYLON.Texture("assets/TEX_Trim_A_M.png", null, false, false, 3);
